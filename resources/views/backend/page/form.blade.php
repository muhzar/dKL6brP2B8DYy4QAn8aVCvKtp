          		...
          		<div class="col-md-6">
	          		...
	          		<div class="form-group">
	            		...
	            		<select name="category_id">
        					<option value="{{ config('app.page_type_id') }}">None</option>
		          	...
		          	<div class="form-group">
	            		<label for="exampleInputPassword1"><small>Data Model [optional]</small></label>
	            		<input name="data_model" value="{{ old('data_model',  isset($post->data_model) ? $post->data_model : null) }}" type="text" class="form-control" id="exampleInputPassword1" placeholder="data model">
	          		</div>
		          	<div class="form-group">
	            		<label for="exampleInputPassword1"><small>Data Query [optional]</small></label>
	            		<input name="data_query" value="{{ old('data_query',  isset($post->data_query) ? $post->data_query : null) }}" type="text" class="form-control" id="exampleInputPassword1" placeholder="data query">
	          			<!-- <select name="data_query">
        					<option value="">None</option>
	            		</select> -->
	          		</div>
		          	<div class="form-group">
	            		<label for="exampleInputPassword1"><small>Template [optional]</small></label>
	            		<input name="template" value="{{ old('template',  isset($post->template) ? $post->template : null) }}" type="text" class="form-control" id="exampleInputPassword1" placeholder="template">
	          		</div>
          		</div>
          		<div class="col-md-6">
